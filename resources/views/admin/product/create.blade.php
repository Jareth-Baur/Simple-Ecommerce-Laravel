      ...
      <div class="col-md-8 col-12">
        <form action="{{ route('producSave') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" name="title" id="title" class="form-control  @error('title') is-invalid @enderror" placeholder="Black Elite 1989" value="{{ old('title') }}" required>
            @error('title') 
          ...
          <div class="form-group">
              ...
              <textarea name="desc" id="desc" cols="30" class="form-control @error('desc') is-invalid @enderror" placeholder="Mentholized vape for . . ." required>{{ old('desc') }}</textarea>
              @error('desc')
